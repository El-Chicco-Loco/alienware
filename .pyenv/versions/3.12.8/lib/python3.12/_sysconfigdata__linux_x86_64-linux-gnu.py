...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/home/alienware/.pyenv/versions/3.12.8/bin',
 'BINLIBDEST': '/home/alienware/.pyenv/versions/3.12.8/lib/python3.12',
 'BLDLIBRARY': '-L. -lpython3.12',
 'BLDSHARED': 'gcc -shared -L/home/alienware/.pyenv/versions/3.12.8/lib '
              '-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib '
              '-L/home/alienware/.pyenv/versions/3.12.8/lib '
              '-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Wextra -Wno-unused-parameter '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/home/alienware/.pyenv/versions/3.12.8/include',
 'CONFIGURE_LDFLAGS': '-L/home/alienware/.pyenv/versions/3.12.8/lib '
                      '-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/home/alienware/.pyenv/versions/3.12.8' "
                "'--enable-shared' "
                "'--libdir=/home/alienware/.pyenv/versions/3.12.8/lib' "
                "'LDFLAGS=-L/home/alienware/.pyenv/versions/3.12.8/lib "
                "-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib' "
                "'LIBS=-L/home/alienware/.pyenv/versions/3.12.8/lib "
                "-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib' "
                "'CPPFLAGS=-I/home/alienware/.pyenv/versions/3.12.8/include'",
 ...
 'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage '
                            ...
                            ')]"',
 'CPPFLAGS': '-I. -I./Include -I/home/alienware/.pyenv/versions/3.12.8/include '
             '-I/home/alienware/.pyenv/versions/3.12.8/include',
 'CXX': 'g++',
 'DEEPFREEZE_C': 'Python/deepfreeze/deepfreeze.c',
 'DEEPFREEZE_DEPS': './Tools/build/deepfreeze.py _bootstrap_python '
                    './Programs/_freeze_module.py \\',
 'DEEPFREEZE_OBJS': 'Python/deepfreeze/deepfreeze.o',
 'DESTDIRS': '/home/alienware/.pyenv/versions/3.12.8 '
             '/home/alienware/.pyenv/versions/3.12.8/lib '
             '/home/alienware/.pyenv/versions/3.12.8/lib/python3.12 '
             '/home/alienware/.pyenv/versions/3.12.8/lib/python3.12/lib-dynload',
 'DESTLIB': '/home/alienware/.pyenv/versions/3.12.8/lib/python3.12',
 'DESTPATH': '',
 'DESTSHARED': '/home/alienware/.pyenv/versions/3.12.8/lib/python3.12/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'EXE': '',
 'EXEMODE': 755,
 'EXENAME': '/home/alienware/.pyenv/versions/3.12.8/bin/python3.12',
 'EXPORTSFROM': '',
 'EXPORTSYMS': '',
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 ...
 'INCLDIRSTOMAKE': '/home/alienware/.pyenv/versions/3.12.8/include '
                   '/home/alienware/.pyenv/versions/3.12.8/include '
                   '/home/alienware/.pyenv/versions/3.12.8/include/python3.12 '
                   '/home/alienware/.pyenv/versions/3.12.8/include/python3.12',
 'INCLUDEDIR': '/home/alienware/.pyenv/versions/3.12.8/include',
 'INCLUDEPY': '/home/alienware/.pyenv/versions/3.12.8/include/python3.12',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -shared -L/home/alienware/.pyenv/versions/3.12.8/lib '
                '-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib '
                '-L/home/alienware/.pyenv/versions/3.12.8/lib '
                '-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib',
 'LDFLAGS': '-L/home/alienware/.pyenv/versions/3.12.8/lib '
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -shared -L/home/alienware/.pyenv/versions/3.12.8/lib '
             '-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib '
             '-L/home/alienware/.pyenv/versions/3.12.8/lib '
             '-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib',
 'LDVERSION': '3.12',
 'LIBC': '',
 'LIBDEST': '/home/alienware/.pyenv/versions/3.12.8/lib/python3.12',
 'LIBDIR': '/home/alienware/.pyenv/versions/3.12.8/lib',
 ...
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare '
                    ...
                    '-I/home/alienware/.pyenv/versions/3.12.8/include '
                    '-I/home/alienware/.pyenv/versions/3.12.8/include -fPIC '
                    '-fPIC',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/alienware/.pyenv/versions/3.12.8/lib/pkgconfig',
 'LIBPL': '/home/alienware/.pyenv/versions/3.12.8/lib/python3.12/config-3.12-x86_64-linux-gnu',
 'LIBPYTHON': '',
 'LIBRARY': 'libpython3.12.a',
 'LIBRARY_DEPS': 'libpython3.12.a libpython3.12.so libpython3.so',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-ldl -L/home/alienware/.pyenv/versions/3.12.8/lib '
         '-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': 'gcc',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/home/alienware/.pyenv/versions/3.12.8/lib/python3.12',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/home/alienware/.pyenv/versions/3.12.8/share/man',
 ...
 'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall '
                   ...
                   '-I/home/alienware/.pyenv/versions/3.12.8/include -fPIC '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/home/alienware/.pyenv/versions/3.12.8/lib '
                    '-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib '
                    '-L/home/alienware/.pyenv/versions/3.12.8/lib '
                    '-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib',
 ...
 'PY_LDFLAGS': '-L/home/alienware/.pyenv/versions/3.12.8/lib '
               '-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib '
               '-L/home/alienware/.pyenv/versions/3.12.8/lib '
               '-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-L/home/alienware/.pyenv/versions/3.12.8/lib '
                     '-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib '
                     '-L/home/alienware/.pyenv/versions/3.12.8/lib '
                     '-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib',
 ...
 'SHELL': '/bin/sh -e',
 'SHLIBS': '-ldl -L/home/alienware/.pyenv/versions/3.12.8/lib '
           '-Wl,-rpath,/home/alienware/.pyenv/versions/3.12.8/lib',
 'SHLIB_SUFFIX': '.so',
 ...
 'VERSION': '3.12',
 'WASM_ASSETS_DIR': './home/alienware/.pyenv/versions/3.12.8',
 'WASM_STDLIB': './home/alienware/.pyenv/versions/3.12.8/lib/python3.12/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 0,
