...
hl.bind(mod .. " + M", function()
  if proc.running("phanpy", false) then
    hl.dispatch(hl.dsp.workspace.toggle_special("phanpy"))
  else
    hl.dispatch(hl.dsp.exec_cmd("chromium --app='https://phanpy.social/' --user-agent='Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36' --user-data-dir='~/.local/state/phanpy/'"))
  end
end, { desc = "Toggle Phanpy" })
