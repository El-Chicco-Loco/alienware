...
function ScanningIndicator() {
   ...
   return (
      <image iconName={icons.refresh} pixelSize={theme["icon-size"].normal} cssClasses={className} />
   );
}
   ...
   return (
      ...
      >
         <box spacing={theme.spacing}>
            ...
            />
            <box hexpand />
            <image iconName={icons.check} pixelSize={theme["icon-size"].normal} visible={connected} />
         </box>
      </button>
   );
}
