...
export const icons = {
   ...
   network: {
      wifi: {
         ...
         1: "network-wireless-connected-100",
         2: "network-wireless-connected-75",
         3: "network-wireless-connected-50",
         4: "network-wireless-connected-25",
         5: "network-wireless-connected-00",
      },
   ...
   battery: {
      charging: "battery-medium-charging-symbolic",
      1: "battery-full-symbolic",
      2: "battery-level-70-symbolic",
      3: "battery-level-40-symbolic",
