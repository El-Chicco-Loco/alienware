/*** Autogenerated by WIDL 11.2 from /home/runner/build_wine/wine/include/msinkaut.idl - Do not edit ***/
...
#endif /* defined __InkDisp_FWD_DEFINED__ */
...
#endif /* defined __cplusplus */
#endif /* defined __InkOverlay_FWD_DEFINED__ */
...
typedef enum __WIDL_msinkaut_generated_name_00000025 {
...
DEFINE_GUID(IID_IInkOverlay, 0xb82a463b, 0xc1c5, 0x45a3, 0x99,0x7c, 0xde,0xab,0x56,0x51,0xb6,0x7a);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IInkOverlay : public IDispatch
{
    ...
    virtual HRESULT STDMETHODCALLTYPE get_EditingMode(
        InkOverlayEditingMode *EditingMode) = 0;

    virtual HRESULT STDMETHODCALLTYPE put_EditingMode(
        InkOverlayEditingMode EditingMode) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_Selection(
        IInkStrokes **Selection) = 0;

    virtual HRESULT STDMETHODCALLTYPE put_Selection(
        IInkStrokes *Selection) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_EraserMode(
        InkOverlayEraserMode *EraserMode) = 0;

    virtual HRESULT STDMETHODCALLTYPE put_EraserMode(
        InkOverlayEraserMode EraserMode) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_EraserWidth(
        LONG *EraserWidth) = 0;

    virtual HRESULT STDMETHODCALLTYPE put_EraserWidth(
        LONG EraserWidth) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_AttachMode(
        InkOverlayAttachMode *AttachMode) = 0;

    virtual HRESULT STDMETHODCALLTYPE put_AttachMode(
        InkOverlayAttachMode AttachMode) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE get_SupportHighContrastSelectionUI(
        VARIANT_BOOL *Support) = 0;

    virtual HRESULT STDMETHODCALLTYPE put_SupportHighContrastSelectionUI(
        VARIANT_BOOL Support) = 0;

    virtual HRESULT STDMETHODCALLTYPE HitTestSelection(
        LONG x,
        LONG y,
        SelectionHitResult *SelArea) = 0;

    virtual HRESULT STDMETHODCALLTYPE Draw(
        IInkRectangle *Rect) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInkOverlay, 0xb82a463b, 0xc1c5, 0x45a3, 0x99,0x7c, 0xde,0xab,0x56,0x51,0xb6,0x7a)
#endif
#else
...
interface IInkOverlay {
    CONST_VTBL IInkOverlayVtbl* lpVtbl;
};
...
/*** IInkOverlay methods ***/
#define IInkOverlay_get_hWnd(This,window) (This)->lpVtbl->get_hWnd(This,window)
#define IInkOverlay_put_hWnd(This,window) (This)->lpVtbl->put_hWnd(This,window)
...
#define IInkOverlay_putref_DefaultDrawingAttributes(This,CurrentAttributes) (This)->lpVtbl->putref_DefaultDrawingAttributes(This,CurrentAttributes)
#define IInkOverlay_get_Renderer(This,CurrentInkRenderer) (This)->lpVtbl->get_Renderer(This,CurrentInkRenderer)
#define IInkOverlay_putref_Renderer(This,CurrentInkRenderer) (This)->lpVtbl->putref_Renderer(This,CurrentInkRenderer)
#define IInkOverlay_get_Ink(This,Ink) (This)->lpVtbl->get_Ink(This,Ink)
#define IInkOverlay_putref_Ink(This,Ink) (This)->lpVtbl->putref_Ink(This,Ink)
...
#define IInkOverlay_put_EraserWidth(This,EraserWidth) (This)->lpVtbl->put_EraserWidth(This,EraserWidth)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IInkOverlay_QueryInterface(IInkOverlay* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IInkOverlay_AddRef(IInkOverlay* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IInkOverlay_Release(IInkOverlay* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IInkOverlay_GetTypeInfoCount(IInkOverlay* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IInkOverlay_GetTypeInfo(IInkOverlay* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IInkOverlay_GetIDsOfNames(IInkOverlay* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IInkOverlay_Invoke(IInkOverlay* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IInkOverlay methods ***/
static inline HRESULT IInkOverlay_get_hWnd(IInkOverlay* This,LONG_PTR *window) {
    return This->lpVtbl->get_hWnd(This,window);
}
static inline HRESULT IInkOverlay_put_hWnd(IInkOverlay* This,LONG_PTR window) {
    return This->lpVtbl->put_hWnd(This,window);
}
static inline HRESULT IInkOverlay_get_Enabled(IInkOverlay* This,VARIANT_BOOL *Collecting) {
    return This->lpVtbl->get_Enabled(This,Collecting);
}
static inline HRESULT IInkOverlay_put_Enabled(IInkOverlay* This,VARIANT_BOOL Collecting) {
    return This->lpVtbl->put_Enabled(This,Collecting);
}
static inline HRESULT IInkOverlay_get_DefaultDrawingAttributes(IInkOverlay* This,IInkDrawingAttributes **CurrentAttributes) {
    return This->lpVtbl->get_DefaultDrawingAttributes(This,CurrentAttributes);
}
static inline HRESULT IInkOverlay_putref_DefaultDrawingAttributes(IInkOverlay* This,IInkDrawingAttributes *CurrentAttributes) {
    return This->lpVtbl->putref_DefaultDrawingAttributes(This,CurrentAttributes);
}
static inline HRESULT IInkOverlay_get_Renderer(IInkOverlay* This,IInkRenderer **CurrentInkRenderer) {
    return This->lpVtbl->get_Renderer(This,CurrentInkRenderer);
}
static inline HRESULT IInkOverlay_putref_Renderer(IInkOverlay* This,IInkRenderer *CurrentInkRenderer) {
    return This->lpVtbl->putref_Renderer(This,CurrentInkRenderer);
}
static inline HRESULT IInkOverlay_get_Ink(IInkOverlay* This,IInkDisp **Ink) {
    return This->lpVtbl->get_Ink(This,Ink);
}
static inline HRESULT IInkOverlay_putref_Ink(IInkOverlay* This,IInkDisp *Ink) {
    return This->lpVtbl->putref_Ink(This,Ink);
}
static inline HRESULT IInkOverlay_get_AutoRedraw(IInkOverlay* This,VARIANT_BOOL *AutoRedraw) {
    return This->lpVtbl->get_AutoRedraw(This,AutoRedraw);
}
static inline HRESULT IInkOverlay_put_AutoRedraw(IInkOverlay* This,VARIANT_BOOL AutoRedraw) {
    return This->lpVtbl->put_AutoRedraw(This,AutoRedraw);
}
static inline HRESULT IInkOverlay_get_CollectingInk(IInkOverlay* This,VARIANT_BOOL *Collecting) {
    return This->lpVtbl->get_CollectingInk(This,Collecting);
}
static inline HRESULT IInkOverlay_get_CollectionMode(IInkOverlay* This,InkCollectionMode *Mode) {
    return This->lpVtbl->get_CollectionMode(This,Mode);
}
static inline HRESULT IInkOverlay_put_CollectionMode(IInkOverlay* This,InkCollectionMode Mode) {
    return This->lpVtbl->put_CollectionMode(This,Mode);
}
static inline HRESULT IInkOverlay_get_DynamicRendering(IInkOverlay* This,VARIANT_BOOL *Enabled) {
    return This->lpVtbl->get_DynamicRendering(This,Enabled);
}
static inline HRESULT IInkOverlay_put_DynamicRendering(IInkOverlay* This,VARIANT_BOOL Enabled) {
    return This->lpVtbl->put_DynamicRendering(This,Enabled);
}
static inline HRESULT IInkOverlay_get_DesiredPacketDescription(IInkOverlay* This,VARIANT *PacketGuids) {
    return This->lpVtbl->get_DesiredPacketDescription(This,PacketGuids);
}
static inline HRESULT IInkOverlay_put_DesiredPacketDescription(IInkOverlay* This,VARIANT PacketGuids) {
    return This->lpVtbl->put_DesiredPacketDescription(This,PacketGuids);
}
static inline HRESULT IInkOverlay_get_MouseIcon(IInkOverlay* This,IPictureDisp **MouseIcon) {
    return This->lpVtbl->get_MouseIcon(This,MouseIcon);
}
static inline HRESULT IInkOverlay_put_MouseIcon(IInkOverlay* This,IPictureDisp *MouseIcon) {
    return This->lpVtbl->put_MouseIcon(This,MouseIcon);
}
static inline HRESULT IInkOverlay_putref_MouseIcon(IInkOverlay* This,IPictureDisp *MouseIcon) {
    return This->lpVtbl->putref_MouseIcon(This,MouseIcon);
}
static inline HRESULT IInkOverlay_get_MousePointer(IInkOverlay* This,InkMousePointer *MousePointer) {
    return This->lpVtbl->get_MousePointer(This,MousePointer);
}
static inline HRESULT IInkOverlay_put_MousePointer(IInkOverlay* This,InkMousePointer MousePointer) {
    return This->lpVtbl->put_MousePointer(This,MousePointer);
}
static inline HRESULT IInkOverlay_get_EditingMode(IInkOverlay* This,InkOverlayEditingMode *EditingMode) {
    return This->lpVtbl->get_EditingMode(This,EditingMode);
}
static inline HRESULT IInkOverlay_put_EditingMode(IInkOverlay* This,InkOverlayEditingMode EditingMode) {
    return This->lpVtbl->put_EditingMode(This,EditingMode);
}
static inline HRESULT IInkOverlay_get_Selection(IInkOverlay* This,IInkStrokes **Selection) {
    return This->lpVtbl->get_Selection(This,Selection);
}
static inline HRESULT IInkOverlay_put_Selection(IInkOverlay* This,IInkStrokes *Selection) {
    return This->lpVtbl->put_Selection(This,Selection);
}
static inline HRESULT IInkOverlay_get_EraserMode(IInkOverlay* This,InkOverlayEraserMode *EraserMode) {
    return This->lpVtbl->get_EraserMode(This,EraserMode);
}
static inline HRESULT IInkOverlay_put_EraserMode(IInkOverlay* This,InkOverlayEraserMode EraserMode) {
    return This->lpVtbl->put_EraserMode(This,EraserMode);
}
static inline HRESULT IInkOverlay_get_EraserWidth(IInkOverlay* This,LONG *EraserWidth) {
    return This->lpVtbl->get_EraserWidth(This,EraserWidth);
}
static inline HRESULT IInkOverlay_put_EraserWidth(IInkOverlay* This,LONG EraserWidth) {
    return This->lpVtbl->put_EraserWidth(This,EraserWidth);
}
static inline HRESULT IInkOverlay_get_AttachMode(IInkOverlay* This,InkOverlayAttachMode *AttachMode) {
    return This->lpVtbl->get_AttachMode(This,AttachMode);
}
static inline HRESULT IInkOverlay_put_AttachMode(IInkOverlay* This,InkOverlayAttachMode AttachMode) {
    return This->lpVtbl->put_AttachMode(This,AttachMode);
}
static inline HRESULT IInkOverlay_get_Cursors(IInkOverlay* This,IInkCursors **Cursors) {
    return This->lpVtbl->get_Cursors(This,Cursors);
}
static inline HRESULT IInkOverlay_get_MarginX(IInkOverlay* This,LONG *MarginX) {
    return This->lpVtbl->get_MarginX(This,MarginX);
}
static inline HRESULT IInkOverlay_put_MarginX(IInkOverlay* This,LONG MarginX) {
    return This->lpVtbl->put_MarginX(This,MarginX);
}
static inline HRESULT IInkOverlay_get_MarginY(IInkOverlay* This,LONG *MarginY) {
    return This->lpVtbl->get_MarginY(This,MarginY);
}
static inline HRESULT IInkOverlay_put_MarginY(IInkOverlay* This,LONG MarginY) {
    return This->lpVtbl->put_MarginY(This,MarginY);
}
static inline HRESULT IInkOverlay_get_Tablet(IInkOverlay* This,IInkTablet **SingleTablet) {
    return This->lpVtbl->get_Tablet(This,SingleTablet);
}
static inline HRESULT IInkOverlay_get_SupportHighContrastInk(IInkOverlay* This,VARIANT_BOOL *Support) {
    return This->lpVtbl->get_SupportHighContrastInk(This,Support);
}
static inline HRESULT IInkOverlay_put_SupportHighContrastInk(IInkOverlay* This,VARIANT_BOOL Support) {
    return This->lpVtbl->put_SupportHighContrastInk(This,Support);
}
static inline HRESULT IInkOverlay_get_SupportHighContrastSelectionUI(IInkOverlay* This,VARIANT_BOOL *Support) {
    return This->lpVtbl->get_SupportHighContrastSelectionUI(This,Support);
}
static inline HRESULT IInkOverlay_put_SupportHighContrastSelectionUI(IInkOverlay* This,VARIANT_BOOL Support) {
    return This->lpVtbl->put_SupportHighContrastSelectionUI(This,Support);
}
static inline HRESULT IInkOverlay_HitTestSelection(IInkOverlay* This,LONG x,LONG y,SelectionHitResult *SelArea) {
    return This->lpVtbl->HitTestSelection(This,x,y,SelArea);
}
static inline HRESULT IInkOverlay_Draw(IInkOverlay* This,IInkRectangle *Rect) {
    return This->lpVtbl->Draw(This,Rect);
}
static inline HRESULT IInkOverlay_SetGestureStatus(IInkOverlay* This,InkApplicationGesture Gesture,VARIANT_BOOL Listen) {
    return This->lpVtbl->SetGestureStatus(This,Gesture,Listen);
}
static inline HRESULT IInkOverlay_GetGestureStatus(IInkOverlay* This,InkApplicationGesture Gesture,VARIANT_BOOL *Listening) {
    return This->lpVtbl->GetGestureStatus(This,Gesture,Listening);
}
static inline HRESULT IInkOverlay_GetWindowInputRectangle(IInkOverlay* This,IInkRectangle **WindowInputRectangle) {
    return This->lpVtbl->GetWindowInputRectangle(This,WindowInputRectangle);
}
static inline HRESULT IInkOverlay_SetWindowInputRectangle(IInkOverlay* This,IInkRectangle *WindowInputRectangle) {
    return This->lpVtbl->SetWindowInputRectangle(This,WindowInputRectangle);
}
static inline HRESULT IInkOverlay_SetAllTabletsMode(IInkOverlay* This,VARIANT_BOOL UseMouseForInput) {
    return This->lpVtbl->SetAllTabletsMode(This,UseMouseForInput);
}
static inline HRESULT IInkOverlay_SetSingleTabletIntegratedMode(IInkOverlay* This,IInkTablet *Tablet) {
    return This->lpVtbl->SetSingleTabletIntegratedMode(This,Tablet);
}
static inline HRESULT IInkOverlay_GetEventInterest(IInkOverlay* This,InkCollectorEventInterest EventId,VARIANT_BOOL *Listen) {
    return This->lpVtbl->GetEventInterest(This,EventId,Listen);
}
static inline HRESULT IInkOverlay_SetEventInterest(IInkOverlay* This,InkCollectorEventInterest EventId,VARIANT_BOOL Listen) {
    return This->lpVtbl->SetEventInterest(This,EventId,Listen);
}
#endif
#endif
...
DEFINE_GUID(CLSID_InkDisp, 0x937c1a34, 0x151d, 0x4610, 0x9c,0xa6, 0xa8,0xcc,0x9b,0xdb,0x5d,0x83);

#ifdef __cplusplus
class DECLSPEC_UUID("937c1a34-151d-4610-9ca6-a8cc9bdb5d83") InkDisp;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(InkDisp, 0x937c1a34, 0x151d, 0x4610, 0x9c,0xa6, 0xa8,0xcc,0x9b,0xdb,0x5d,0x83)
#endif
#endif
...
DEFINE_GUID(CLSID_InkOverlay, 0x65d00646, 0xcde3, 0x4a88, 0x91,0x63, 0x67,0x69,0xf0,0xf1,0xa9,0x7d);

#ifdef __cplusplus
class DECLSPEC_UUID("65d00646-cde3-4a88-9163-6769f0f1a97d") InkOverlay;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(InkOverlay, 0x65d00646, 0xcde3, 0x4a88, 0x91,0x63, 0x67,0x69,0xf0,0xf1,0xa9,0x7d)
#endif
#endif
